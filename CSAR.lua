...
csar.disableTimeoutTime = 3 -- Time in minutes for TIMEOUT
...
csar.requestdelay = 5 -- Time in seconds before the survivors will request Medevac
...
csar.loadDistance = 100 -- configure distance for pilot to get in helicopter in meters.
