...
function SEF_InitializeMissionTable()
  ...
  OperationBlackpool_AG[10] = {
    TargetName = "Palmyra_Roman_Theatre-Armor",
    TargetStatic = false,
  ...
  OperationBlackpool_AG[11] = {
    TargetName = "Palmyra_Castle-Artillery",
    TargetStatic = false,
  ...
  OperationBlackpool_AG[16] = {
    TargetName = "Baalbek-Insurgent_Camp",
    TargetStatic = false,
  ...
  OperationBlackpool_AG[17] = {
   ...
   OperationBlackpool_AG[18] = {
    TargetName = "Beirut-Road_Outpost",
    TargetStatic = true,
  ...
  OperationBlackpool_AG[20] = {
    TargetName = "Lake_Qaraoun-Patrol",
    TargetStatic = false,
  ...
  OperationBlackpool_AG[21] = {
    TargetName = "Jisr-ATTK",
    TargetStatic = false,
