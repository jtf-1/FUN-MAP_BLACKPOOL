...
ctld.maximumMoveDistance = 5000 -- max distance for troops to move from drop point if no enemy is nearby
...
ctld.pickupZones = {
    ...
    { "pickzone9", "none", 5, "no", 1 }, -- limits pickup zone 9 to 5 groups of soldiers or vehicles, only red can pick up
    { "pickzone10", "none", 10, "no", 2 },  -- limits pickup zone 10 to 10 groups of soldiers or vehicles, only blue can pick up
    ...
    { "pickzone13", "none", -1, "no", 0 },
    { "pickzone14", "none", -1, "no", 0 },
    { "pickzone15", "none", -1, "no", 0 },
    { "pickzone16", "none", -1, "no", 0 },
    { "pickzone17", "none", -1, "no", 0 },
    { "pickzone18", "none", -1, "no", 0 },
    { "pickzone19", "none", 5, "no", 0 },
    { "pickzone20", "none", 10, "no", 0, 1000 }, -- optional extra flag number to store the current number of groups available in

    { "USA Carrier", "blue", 10, "no", 0, 1001 }, -- instead of a Zone Name you can also use the UNIT NAME of a ship
}
