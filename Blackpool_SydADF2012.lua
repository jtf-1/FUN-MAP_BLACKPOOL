...
A2ADispatcher:SetSquadron( "IRIAF F-14", "Palmyra", { "IRIAF F-14" }) --F14A
A2ADispatcher:SetSquadronGrouping( "IRIAF F-14", 1 )--Qty=spawns per group
A2ADispatcher:SetSquadronGci2( "IRIAF F-14", 800, 1200, 2000, 5000, "Baro" )
...
Zone.Charlie = ZONE:New("Academy")   --Core.Zone#ZONE
Zone.Delta = ZONE:New("Dumayr")   --Core.Zone#ZONE
...
SCHEDULER:New( nil, function() 
  local mission=AUFTRAG:NewBOMBING(Zone.Charlie,1000)
  local fg=FLIGHTGROUP:New("9th Squadron 1")
  fg:AddMission(mission) 
  
  local mission=AUFTRAG:NewBOMBING(Zone.Delta,1000)
  local fg=FLIGHTGROUP:New("9th Squadron 2")
  fg:AddMission(mission)
  end, {},1800, 3600, .8)
